...
const SuggestContentOutputSchema = z.object({
  suggestions: z
    .array(z.string())
    .describe(
      'An array of 3-5 distinct content suggestions, such as alternative phrasings, expansions, or rewordings for the input text.'
    ),
});
...
Based on the provided text and language, offer 3-5 distinct suggestions to enhance, expand, or rephrase the content.
